...
Но при этом нужно понимать, какую производительность мы измеряем, правильно выбирать условия её измерения и очень важно
...
марафоном*, конечно, это не марафон, а спринт.

Так вот, при старте с места велосипед, конечно, выиграет у поезда на дистанции 100 метров. Выиграет и на 200, и на 1000.
...
*Чистая Архитектура* предназначена для "игры в долгую"
...
*Чистая Архитектура* повышает скорость стайера, она масштабирует скорость разработки на длинных дистанциях.
