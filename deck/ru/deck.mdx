...
Ну а для тех, кто впервые слышит это словосочетание, сформулируем кратко: принципы *Чистой Архитектуры* направлены на
...
минимум, нужно где-то использовать иерархию типов. Минималистичность предлагаемой предметной области не позволяет это
сделать. 
