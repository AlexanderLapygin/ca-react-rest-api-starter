...
В этой презентации будет показано лишь самое существенное: как принципы *Чистой Архитектуры* могут быть представлены в
коде  *TypeScript* - языка, который в среде frontend-разработчиков сегодня имеет многочисленных сторонников, и который
последнее время начинает завоёвывать позиции уже и на backend. 
