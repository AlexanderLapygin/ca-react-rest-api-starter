...
Поэтому в продолжение этой презентации запланировано ещё несколько примерно таких же, на первой из которых
предполагается продемонстрировать развитие показанного здесь решения для мобильных платформ, конкретно - на *React
Native*. 
