...
*Чистая Архитектура* никак не регламентирует ни названия слоёв, ни их число. На оригинальной диаграмме показан просто
самый типовой пример, который и нужно воспринимать как пример, не более того.
