...
простейший счётчик с функциями инкремента и сброса, рассмотрение всех нужных его сторон трудно уместить в одной
презентации.  

В этой презентации будет показано самое существенное: как принципы *Чистой Архитектуры* могут быть представлены в коде
...
Прекрасный разбор терминов и понятий *Чистой Архитектуры*, разрешения возможных недоразумений сделан в работе
...
работы, оставим здесь лишь сухой остаток, необходимый для дальнейшего изложения в виде краткого словаря используемых
терминов с соответствующими комментариями.
...
- *Presenters* - по сути являются адаптерами UI-фреймворков для модулей бизнес-логики.
...
- *Infrastructure* - инфраструктура - всё, что находится во внешнем слое. К типичным представителям инфраструктуры
относятся фреймворки пользовательских интерфейсов (*UI*) и базы данных (*DB*).
