...
между сущностями предметной области и сценариями бизнес-логики, между бизнес-логикой продукта и инфраструктурой,
включающей библиотеки, фреймворки, базы данных и т.п.
