...
- *Adapter* - адаптер - программный модуль, согласующий интерфейсы двух других модулей. В контексте Чистой Архитектуры 
адаптеры часто служат для согласования интерфейсов внутреннего и внешнего архитектурных слоёв. При этом наиболее типовым
случаем является согласование интерфейсов фреймворков и внешних систем с интерфейсами *бизнес-логики*.
...
- *Gateway* - адаптер некоторого сервиса, используемого бизнес-логикой. В частности, сервис может выполнять функции
хранения состояния сущностей (persistence). Иногда в таких случаях вместо *Gateway* используется термин *Repository*.
