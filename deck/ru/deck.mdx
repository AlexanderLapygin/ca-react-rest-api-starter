...
Возможно, найдётся кто-то, кто скажет, что *Правило Зависимостей* очевидно, банально и т.п. - такие всегда находятся.
Но практика показывает, что это не так - его постоянное нарушение является нашей повседневной реальностью.
