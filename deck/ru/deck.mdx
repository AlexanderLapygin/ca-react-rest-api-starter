...
В начале каждого модуля находится самое главное: импорт, экспорт, интерфейсы и конструкторы. Ниже - реализация, но
сейчас речь не о ней.  

У модулей выделены только те строки, которые имеют отношение к соблюдению *Правила Зависимостей*. 
