...
Например, сравнивать скорость разработки на хакатоне (пояснение чуть ниже) и разработки на принципах
*Чистой Архитектуры* - всё равно что сравнивать скорость спринтера и стайера, велосипеда и поезда.

*Хакатон* (сокращённо - *хакерский марафон*), если кто не знает, это своего рода спорт для программистов, предполагающий
разработку программного решения в условиях ограниченного времени, обычно в пределах одной-двух недель.
