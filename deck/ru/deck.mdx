...
Поэтому будет показано только наболее существенное, а именно то, как принципы *Чистой Архитектуры* могут быть
представлены в коде языка, поддерживающего понятие интерфейса. А поскольку здесь рассматривается специфика клиентских
приложений, то сегодня для этого лучше всего подойдёт *TypeScript*, язык, уже имеющий многочисленных сторонников в среде
frontend-разработчиков, и который последнее время начинает завоёвывать позиции также и на backend
([*NestJS*](https://nestjs.com/) и т.п.). 
...
обеспечение долгого и устойчивого развития программного продукта.  
...
вторичными, возможно, добавленными или оставленными для получения красивой аббревиатуры.
