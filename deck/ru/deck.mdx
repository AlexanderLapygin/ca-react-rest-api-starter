...
На слайде видно, что на первой половине стека - от *UI* до *Domain* design-time-зависимости направлены от *consumed* - к
*provided*-интерфейсам, а на второй половине наоборот: от *provided* - к *consumed* - именно так в данном случае
проявляется *Принцип Инверсии Зависимостей*.  
