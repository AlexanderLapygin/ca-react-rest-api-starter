...
- *Infrastructure* - инфраструктура - всё, что находится во внешнем слое - следующем за слоем *Interface Adapters*.
...
статическую типизацию, таких как *Java*, *Kotlin*, *C#*.   
...
Но к коду будем приближаться всё-таки плавно, поэтапно, без резких переходов.
