...
Такой модуль, например, может находиться в слое адаптеров, поскольку слой адаптеров точно имеет соседний внутренний слой -
