...
может быть представлены в коде, в данном случае, в коде *TypeScript*.. 
...
обеспечение долгого и устойчивого развития программного продукта, попросту - его живучести.
