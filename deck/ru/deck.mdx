...
- *Domain* в контексте Чистой Архитектуры означает то же самое, что *бизнес логика*. Как правило, подразделяется на два
...
- *Use Cases* - логически замкнутые, **самодостаточные** сценарии использования функциональностей (feature) системы.
В некоторых контекстах совокупность *Use Cases* понимются, как слой *бизнес-логики*, относящийся к конкретному
программному продукту.
*Use Case* - одно из ключевых понятий Чистой Архитектуры, поскольку на нём базируется *SRP* - *Принцип Единой
Ответственности*, который, несмотря на своё неудачное название, является одним из самых главных принципов.
- *Adapters* - адаптеры ...
