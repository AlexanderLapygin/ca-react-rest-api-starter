...
Обозначим зависимости в целом - на уровне директорий в соответствии с *Правилом Зависимости* *Чистой Архитектуры*.
...
И в завершении диаграммы добавим линию, указывающую направление потока управления - от действия пользователя на вершине
стека и до самого его дна, где происходит реакция сервиса на это действие на серверной стороне. 
