...
Сразу стоит сказать, что эта презентация продолжает эксперименты по созданию самодостаточного информационного продукта,
своего рода презентации-статьи, когда она изначально создаётся для полноценного восприятия не только при озвучивании
докладчиком, но и без него. Для этого слайды сопровождаются достаточно подробными *заметками докладчика*, адресованными
не столько докладчику, сколько заинтересованному читателю.
...
Ну а для тех, кому эта тема совсем незнакома, сформулируем кратко, немного перефразировав Википедию:
...
кодинга.
Она для тех, кто играет в долгую.
...
Наверное, здесь стоит сделать небольшое отступление для того, чтобы кому-то напомнить, кому-то пояснить, в чём состоит
*Правило Зависимостей*, и для чего оно нужно.
...
Его суть очень проста, она состоит в следующем: более значимые свойства системы не должны зависеть от менее значимых.

Именно это правило в наибольшей степени придаёт системе живучесть и устойчивость к изменениям в долгосрочном периоде.

На диаграммах, *Правило* обычно изображается стрелками, показывающими направление зависимостей: от инфраструктуры - к
бизнес-логике, от периферии - к центру. 
...
При этом соотношения значимости свойств в каждой конкретной системе могут быть свои, и в первую очередь, разумеется, эти
