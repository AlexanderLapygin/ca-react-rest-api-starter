...
Рассмотрим простую организацию модуля архитектурного слоя. Например, такой модуль может находиться в слое адаптеров,
поскольку этот слой точно имеет соседний внутренний слой - *Use Cases* - и соседний внешний слой - *Infrastructure*. 
...
С учётом вышесказанного упрощённая диаграмма слоёв-модулей может выглядеть, как на этом слайде.
