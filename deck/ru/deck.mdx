...
<p style="font-size: 70px; text-align:left; padding:100px;">
    <i>Модуль архитектурного слоя не должен ничего импортировать из модулей внешних по отношению к нему слоёв.
    <br/>
    При этом он может импортировать из модулей своего слоя и из модулей внутренних слоёв.</i>
</p>
...
может импортировать из модулей своего слоя и из модулей внутренних слоёв.*
