...
*Чистая Архитектура* не является серебряной пулей, она вряд ли подойдёт любителям хакатонов и рыцарям наколенного
кодинга.

Для справки, если совсем коротко: *хакатон - разработка программы на время*
...
С производительностью всё замечательно.

Но важно правильно выбирать условия её измерения и очень важно избегать некорректных сравнений.
...
Например, сравнивать скорость системы, разработанной на хакатоне и системы, разработанной на принципах *Чистой
Архитектуры* - всё равно что сравнивать скорость велосипеда и поезда при старте с места.

Велосипед, конечно, выиграет на дистанции 100 метров. Выиграет и на 200, на 1000.
...
*Чистая Архитектура* нужна тем, кто собирается "играть в долгую".
...
Главный из этих принципов будет здесь рассмотрен, после чего тревожные ожидания покинут тех, у кого они были, и многим
