...
- *Infrastructure* - инфраструктура - всё, что находится во внешнем слое. К её типичным представителям относятся базы
данных (*DB*) и пользовательские интерфейсы (*UI*) со своими фреймворками.
